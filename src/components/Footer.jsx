...
function Footer() {
  return (
    <div className="w-full h-screen px-10 py-10 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div>
          {["eye-", "opening"].map((items, index) => (
            <h1 className=" font-oswald font-black text-[8vw] leading-[7vw] uppercase tracking-tighter">
              {items}
            </h1>
          ))}
        </div>
      ...
      <div className="w-1/2 h-full">
        <h1 className="font-oswald font-black text-[6.27vw]  uppercase tracking-tighter">
          presentations
        </h1>
        <div className="w-full h-[80%] flex gap-5">
          <div className="w-1/2 h-full flex flex-col justify-between">
            <div className="one flex flex-col gap-4">
              <h1 className="text-lg uppercase font-raleway font-medium">s:</h1>
              <div className="flex flex-col gap-2">
                {["instagram", "behance", "facebook", "linked in"].map(
                  (items, index) => (
                    <a
                      href="#"
                      className=" font-raleway transition-all ease-linear duration-200 hover:underline text-md capitalize font-medium"
                    >
                      {items}
                    </a>
                  )
            ...
            <div className="one flex flex-col gap-4">
              <h1 className="text-lg uppercase font-raleway font-medium">l:</h1>
              <div className="flex flex-col gap-2">
                {[
                  "202-1965 W 4th Ave",
                  "Vancouver, Canada",
            ...
            <div className="one flex flex-col gap-4">
              <h1 className="text-lg uppercase font-raleway font-medium">e:</h1>
              <div className="flex flex-col gap-2">
            ...
            <div>
              <h1 className="lowercase text-sm font-raleway font-medium">
                &copy:ochi design 2024. Legal Terms
              </h1>
            </div>
          </div>
          <div className="w-1/2 h-full  flex flex-col justify-between items-end">
            <div className="one mt-28 flex flex-col gap-4">
              <h1 className="text-lg uppercase font-raleway font-medium">m:</h1>
              <div className="flex flex-col gap-2">
                {[
                  "home",
                  "services",
            ...
            <div>
              <h1 className="capitalize  text-sm font-raleway font-medium">
                designed by Obys
              </h1>
            </div>
          </div>
